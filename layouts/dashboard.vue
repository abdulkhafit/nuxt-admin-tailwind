<template>
  <div
    class="flex h-screen bg-gray-50 dark:bg-gray-900 overflow-hidden:true dark"
  >
    <sidebar-dashboard v-if="sideBarDesktop"></sidebar-dashboard>
    <mobile-sidebar v-if="sideBarMobile"></mobile-sidebar>
    <div class="flex flex-col flex-1 w-full">
      <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
        ...
        >
          ...
          <!-- Dekstop hamburger -->
          <button
            class="p-1 mr-5 -ml-1 rounded-md lg focus:outline-none focus:shadow-outline-purple"
            aria-label="Menu"
            @click="closeSidebarDekstop()"
            v-if="tonggleMobile == false"
          >
            <svg
              class="w-6 h-6"
              aria-hidden="true"
    ...
    "window.width": {
      handler() {
        if (this.window.width < 768) {
          this.tonggleMobile = true;
        } else {
          this.tonggleMobile = false;
        }
      },
    },
  },
